...
import { DocumentsIndex } from "./documents/DocumentsIndex";
      ...
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/documents" component={DocumentsIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
